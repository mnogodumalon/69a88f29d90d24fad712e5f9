...
export function StrassenschadenmeldungenDialog({ open, onClose, onSubmit, defaultValues, schadenskategorienList, enablePhotoScan = true, enablePhotoLocation = true }: StrassenschadenmeldungenDialogProps) {
