...
import { FileText, LayoutDashboard, Menu, Settings, Tag, Undo2 } from 'lucide-react';
import { useState, useEffect } from 'react';
import ChatWidget from '@/components/ChatWidget';
import { TopBar } from '@/components/TopBar';

// ⚡ Customize these for your app
const APP_TITLE = 'Straßenschadenmanagement';
...
const navigation = [
  ...
  { name: 'Schadenskategorien', href: '/schadenskategorien', icon: Tag },
  { name: 'Straßenschadenmeldungen', href: '/straßenschadenmeldungen', icon: FileText },
];

const externalNavigation = [
  { name: 'Schadenskategorien', href: '/gateway/apps/69a88f1447fb7f5d2471145f?template=list_page', icon: Tag },
  { name: 'Straßenschadenmeldungen', href: '/gateway/apps/69a88f176e17923d1eb5585a?template=list_page', icon: FileText },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      >
        ...
        <nav className="px-3 pt-4 space-y-0.5">
          <a
            href="/gateway/apps/69a88f1447fb7f5d2471145f?template=list_page"
